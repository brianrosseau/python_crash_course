# Exercise 9-9
# Use final version of electric_car.py
...
class Battery:
    ...
    # Add method that checks battery size and upgrades to if not already 65.
    def upgrage_battery(self):
        """Checks the battery size and sets capacity to 65."""
        if self.battery_size == 40:
            self.battery_size = 65
            print("Upgraded the battery to 225 kWh.")
        else:
...
my_leaf.battery.upgrage_battery()
my_leaf.battery.describe_battery()
my_leaf.battery.get_range()